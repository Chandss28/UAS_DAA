...
class MerchandisePolicy
{
    ...
    {
        return $user->can('view_any_merchandise');
    }
    ...
    {
        return $user->can('view_merchandise');
    }
    ...
    {
        return $user->can('create_merchandise');
    }
    ...
    {
        return $user->can('update_merchandise');
    }
    ...
    {
        return $user->can('delete_merchandise');
    }
    ...
    {
        return $user->can('delete_any_merchandise');
    }
